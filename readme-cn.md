...
[![Go](https://github.com/melonwool/go-zero/workflows/Go/badge.svg?branch=master)](https://github.com/melonwool/go-zero/actions)
[![Go Report Card](https://goreportcard.com/badge/github.com/melonwool/go-zero)](https://goreportcard.com/report/github.com/melonwool/go-zero)
[![goproxy](https://goproxy.cn/stats/github.com/melonwool/go-zero/badges/download-count.svg)](https://goproxy.cn/stats/github.com/melonwool/go-zero/badges/download-count.svg)
[![codecov](https://codecov.io/gh/tal-tech/go-zero/branch/master/graph/badge.svg)](https://codecov.io/gh/tal-tech/go-zero)
[![Release](https://img.shields.io/github/v/release/tal-tech/go-zero.svg?style=flat-square)](https://github.com/melonwool/go-zero)
...
```shell
GO111MODULE=on GOPROXY=https://goproxy.cn/,direct go get -u github.com/melonwool/go-zero
```
...
1. 安装 goctl 工具
    ...
    ```shell
    GO111MODULE=on GOPROXY=https://goproxy.cn/,direct go get -u github.com/melonwool/go-zero/tools/goctl
    ```
...
项目地址：[https://github.com/melonwool/go-zero](https://github.com/melonwool/go-zero)
